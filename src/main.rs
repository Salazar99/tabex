...
fn main() {
    ...
    let options = TableauOptions { max_depth: 10000, graph_output: GRAPH_OUTPUT, memoization: MEMOIZATION, simple_first: SIMPLE_FIRST, jump_rule_enabled: JUMP_RULE_ENALED };
