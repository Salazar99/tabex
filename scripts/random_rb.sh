...
NUM_REAL_VARS_LIST=(1 3)
MAX_REAL_CONSTRAINTS_LIST=(5 10)
MAX_HORIZON_LIST=(50 250 1000)
MAX_INTERVAL_LIST=(50 200)
P_STOP_BASE_LIST=(0.05 0.1)
P_TEMPORAL_LIST=(0.5 0.95)
NUM_CONJUNCTIONS_LIST=(5 10)
NUM_FORMULAS_LIST=10
